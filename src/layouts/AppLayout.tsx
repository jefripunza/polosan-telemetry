...
export default function AppLayout() {
  ...
  const { language, toggleLanguage, clearAuth, token } = useAppStore();
      ...
      return (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M9.348 14.651a3.75 3.75 0 010-5.303m5.304 0a3.75 3.75 0 010 5.303m-7.425 2.122a7.5 7.5 0 010-10.606m9.546 0a7.5 7.5 0 010 10.606M12 12h.01"
          />
        </svg>
      );
    }
          ...
          <header className="bg-white shadow-sm border-b border-gray-200">
            <div className="flex items-center justify-between px-4 py-4">
              ...
              <h1 className="text-xl font-semibold text-gray-900 lg:ml-0">
                {menuItems.find(
                  (item) => `/app/${item.path}` === location.pathname
                )?.name || "Dashboard"}
              </h1>
